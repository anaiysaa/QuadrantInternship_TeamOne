...
@app.route("/SoftwareLicenses", methods=["GET"])
def get_SoftwareLicenses():
    return fetch_all("SoftwareLicenses")

@app.route("/ITInventory", methods=["GET"])
def get_ItInventory():
    return fetch_all("InventoryItems")
