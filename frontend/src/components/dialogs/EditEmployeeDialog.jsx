...
function EditEmployeeDialog({ open, onOpenChange, employee, onEdit }) {
  ...
  useEffect(() => {
    if (employee && open) {
      setForm({
        ...
        // Show either the manager id or name (prefer id)
        manager: employee.managerId || employee.managerName || '',
