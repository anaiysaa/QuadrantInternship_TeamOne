...
import HRTicketsForm from "../componenets/HR-ticket/HRTicketsForm";
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-zinc-900 text-white px-8 py-2 flex flex-col">
        <div className="flex items-center justify-between">
          <span className="opacity-70 text-base">Contact (tickets) HR</span>
      ...
      <div className="flex flex-col md:flex-row gap-6 px-4 md:px-10 py-8">
        ...
        <div className="flex-1 max-w-md">
          <div className="mb-4 flex items-center gap-2">
            ...
            <h2 className="text-2xl font-medium">HR Tickets</h2>
          </div>
          <HRTicketsForm />
        </div>
        {/* Pending Tickets */}
        ...
        <div className="flex-1 max-w-xs">
          <h2 className="text-2xl font-medium mb-4">HR Directory</h2>
          <HRDirectory />
        </div>
      </div>
    </div>
